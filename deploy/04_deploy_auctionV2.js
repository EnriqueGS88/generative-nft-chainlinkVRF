...
module.exports = async({
   ...
   */
   ...
   log("An AuctionV2 is about to get deployed")
   const AuctionV2 = await deploy('AuctionV2', {
        from: deployer,
        log: true
   })
   log("You have deployed your AuctionV2 contract!")
   const networkName = networkConfig[chainId]["name"]
   //log(`Verify with: \n npx hardhat verify --network ${networkName} ${AuctionV2.address} ${args.toString().replace(/,/g, " ")}`)
   log(`Verify with: \n npx hardhat verify --network ${networkName} ${AuctionV2.address}`)
...
module.exports.tags = ['all','auctv2']