...
module.exports = async({
   ...
   */
   ...
   log("An Auction is about to get deployed")
   const Auction = await deploy('Auction', {
        from: deployer,
        log: true
   })
   log("You have deployed your Auction contract!")
   const networkName = networkConfig[chainId]["name"]
   //log(`Verify with: \n npx hardhat verify --network ${networkName} ${Auction.address} ${args.toString().replace(/,/g, " ")}`)
